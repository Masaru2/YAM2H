...
The aiming of this project is to make Earthbound as closest to Mother 2 as possible while keeping it vanilla EB/M2. ("Unlike nothing ever done before")
with the difference is restoring stuff unnoticed by these called "Restoration projects".
...
-Graphics, Tilesets and Sprites reverted as how they were in Mother 2
...
-Changed "Stop looking at my hips" to "Stop looking at my butt" which is a closer approximation of what was the original intention
...
Clyde Mandelin/Tomato - For making both the Legends of Localization Earthbound website and book
